...
- installed additional packages:
		...
		zsh nmap bridge-utils neofetch lshw raspberrypi-kernel-headers bc git libncurses5-dev libparted-dev alsa-tools libasound2-dev bsdtar lrzip autotools-dev dh-make xutils-dev
