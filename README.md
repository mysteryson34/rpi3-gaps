...
- installed additional packages:
		...
		zsh nmap bridge-utils neofetch lshw raspberrypi-kernel-headers bc git libncurses5-dev parted libparted-dev alsa-tools alsa-utils libasound2-dev bsdtar lrzip autotools-dev dh-make xutils-dev
